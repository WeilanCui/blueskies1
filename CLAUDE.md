...
- Traefik's three routing replicas do not run ACME. A singleton external issuer publishes
  immutable certificate bundles and one sync task per manager activates the same bundle on
